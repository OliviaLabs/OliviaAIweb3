    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0" style={{ zIndex: 2147483647 }}>
        ...
        <div className="bg-black/50 backdrop-blur-md">
          ...
          {(userMessage || aiResponse || isAiTyping) && (
          ...
          {/* 💬 CHAT MESSAGES - Shows conversation above input */}
          {(userMessage || aiResponse || isAiTyping) && !isChatMinimized && (
            <div className="px-4 pb-2 space-y-2 max-h-[40vh] overflow-y-auto relative">
              {/* User Message */}
              {userMessage && (
                <div className="flex justify-end animate-fade-in">
                  <div className="bg-green-500/20 border border-green-500/50 rounded-lg px-4 py-2 max-w-[80%]">
                    <div className="text-xs text-green-400 mb-1">You</div>
                    <div className="text-white text-sm">{userMessage}</div>
                  </div>
                </div>
              )}
